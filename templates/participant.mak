...
<div class='jumbotron'>
    <img class="uglymug col-mid-2" alt="${participant_data['name']}'s avatar" src="${gravatar(participant_data['rit_dce'] + '@rit.edu')}"/>
    <h1 class="col-mid-4">${participant_data['irc']}</h1>
    ...
    <div class="col-md-8">
        <p>
            ...
            %if 'twitter' in participant_data:
                <h2>Twitterverse</h2>
                <a class="twitter-timeline"  href="http://twitter.com/${participant_data['twitter']}"  data-widget-id="369925299250544640" data-screen-name=${participant_data['twitter']} target="_blank">Tweets by @${participant_data['twitter']}</a>
